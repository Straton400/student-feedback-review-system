...
<html>
   ...
   <link href="vendor/datepicker/daterangepicker.css" rel="stylesheet" media="all">
    ...
    <header id="header" class="alt">
      <div class="logo"><a href="home.php">Welcome to <span>Student Feedback review System</span></a></div>
      <a href="#menu">Menu</a>
    </header>
           ...
           <div class="form-group">
            ...
            <div class="form-group">
                <input type="password" class="form-control" id="inputPassword" style="color:white;font-size: 1.2em" placeholder="Password" name="p" required>
						...
						<button type="reset" style="background-color: #ff6600" value="Reset" class="btn btn-warning"/> Reset </button><br>

             <a href="login1.php" style="background-color: #ff6600" ><h3>login</h3></a>
