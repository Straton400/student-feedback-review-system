    ...
    <nav id="menu">
      ...
      <ul class="links">
		...
		<!-- One -->
            ...
            <h2 style="color:white; margin-top: 60px; font-size: 40px">Admin Login </h2>
					</header>
			</div>
      ...
      <!-- <h2 style="margin-top: 10px; margin-bottom: 20px; text-align: center; color:#ffffff">Student Signup</h2> -->
       <form id="signup" method="post">
           ...
           <div class="form-group">
            ...
            <div class="form-group">
                <input type="password" class="form-control" id="inputPassword" style="color:white;font-size: 16px" placeholder="Password" name="pass" required>
            </div>
