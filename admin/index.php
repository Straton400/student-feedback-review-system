...
<head>
    ...
    <style>
      ...
      .main-panel{
        background-image: url('C:\johnson osima\xammp\htdocs\Student-Feedback\images\image7.jpg');
                ...
                <ul class="nav">
                    ...
                    <li class="dropdown" style="color:black">
                      ...
                      <ul class="dropdown-menu" style="background-color: black">
                          ...
                          <li><a href="add_student1.php"><i class="fa fa-plus fa-fw" style="height: 2px;width:2px;margin-right:50px;color:white"></i>Add Student</a></li>
                      </ul>
                    </li>
                    <br>
