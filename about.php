    ...
    <!-- Navigation -->
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header" align="center"><font color="#00FF33">STUDENT FEEDBACK REVIEW SYSTEM</font> </h1>
        ...
        <div class="row" style="margin-bottom:50px;margin-left:50px">
               ...
               <P>Student Feedback system for university
Here we have developed the a student feedback review system, which is generally can be used in the college/university to rate the faculty based on the performance...Here we have 2 modules such as administrator, student.
...
If you entere the student user and password and selected student option, then it will show all student information and let you enter the feedback based on the subject..
