...
<head>
    ...
    <title>STUDENT FEEDBACK REVIEW SYSTEM</title>
                            ...
                            <div class="card">
                                ...
                                <div class="content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label><b> Head of department </b></label>
                                                    <input type="text" class="form-control" placeholder="Head of department "  value="<?php echo @$hod;?>" name="Designation" required>
                                                </div>
                                            </div>
