              ...
              <form method="post">
                <div style="color: white "><?php
                  ...
                  echo @$err;
                    ...
                    ?>
              <h3 ><center><u><b>Please give your answer about the following question by circling the given grade on the scale:</b></center></h3><br>

              <div class="row">
                <button type="button" style="margin-left: 380px;font-size:15px;color:white;background-color:green;border:4px solid #336600;padding:5px">Strongly Agree 5</button>
                <button type="button" style="margin-left: 20px;font-size:15px;color:white;background-color:Brown;border:4px solid #336600;padding:5px">Agree 4</button>
                <button type="button" style="margin-left: 20px;font-size:15px;color:white;background-color:blue;border:4px solid #336600;padding:5px">Neutral 3</button>
                <button type="button" style="margin-left: 20px;font-size:15px;color:white;background-color:Black;border:4px solid #336600;padding:5px"> Disagree 2</button>
                <button type="button" style="margin-left: 20px;font-size:15px;color:white;background-color:red;border:4px solid #336600;padding:5px">Strongly Disagree 1</button><br>
                                          ...
                                          <div class="col-md-6">
                                            ...
                                            <select name="faculty" class="form-control">
                                               <option value="" disabled selected>Program</option>
                                                      <option style="color:black">BSc.EE</option>
                                                      <option style="color:black">BSc.ESM</option>
                                                      <option style="color:black">B.Arch</option>
                                                      <option style="color:black">BSc.ID</option>
                                                      <option style="color:black">BSc.LA</option>
                                                      <option style="color:black">BSc.ISM</option>
                                                      <option style="color:black">BSc.Gm</option>
                                                      <option style="color:black">BSc.URP</option>
                                                      <option style="color:black">BSc.RDP</option>
                                                      <option style="color:black">BSc.LMV</option>
                                                      <option style="color:black">BSc.CSN</option>
                                                      <option style="color:black">BSc.CDS</option>
                                                      <option style="color:black">BSc.PFM</option>
                                            	<?php
